...
> **Status:** 🟢 Implemented — Five-Tier Runtime + M3 Judge-Visible Surface (M1 local, M2 Cloud Run, M3 provenance/validation/uncertainty/human-control). Real Gemini 3.5 via Vertex AI + Google ADK 2 integrated (ADR-001/008 fulfilled). 231 tests green (1 skipped live-token-gated).
