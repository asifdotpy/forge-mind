...
- `pytest tests/` green (143/143 — 5 contract baseline + 19 Phase 1 + 18 Phase 2 + 15 Phase 3 + 18 Phase 4 + 15 Phase 5 + 23 Phase 6 + 7 ADR-009 boundary + 6 M3-A surface + 7 M3-B ADK + 4 integration + 6 secret-handling) *(+2: `/adk/events` real-DAG parity + conservative event-only guard, 2026-08-27)*
